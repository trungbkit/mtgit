...
/**
 * The repo tab strip (G12), and on macOS the window's titlebar.
 *
 ...
 *
 * The right end carries the window-level controls: what acts on the *app*
 * rather than on the active repository. Settings sits there rather than in the
 * toolbar for that reason — and because the toolbar's right group was drawing
 * it with the same `gear` glyph as the Actions menu beside it, which makes a
 * group of four a coin flip rather than a group.
 *
 * Only `.tab-strip` scrolls. The row itself cannot: it now holds those
 * controls, and a scroller would carry them off the right edge with the tabs.
 */
  ...
  return (
    <div className="tab-bar">
      ...
      <div className="tab-bar-right">
        <button className="tab-bar-icon" title="Settings" aria-label="Settings" onClick={openSettings}>
